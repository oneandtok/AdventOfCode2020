...
int main() {
    ...
    for (const auto& direction : directions) {
        ...
        if ((direction.first == "R" && direction.second ==  90) ||
            ...
            if (now_position.first >= 0 &&  now_position.second >= 0) {
                std::cout << "[" << now_position.first << ", " << nouw_po
                now_position = std::make_pair(now_position.second, now_position.first * -1);
                continue;
            }
        ...
        if ((direction.first == "R" && direction.second == 180) ||
            ...
            now_position = std::make_pair(now_position.second * -1, now_position.first * -1);
            continue;
        }
        ...
        if ((direction.first == "R" && direction.second == 270) ||
            ...
            if (now_position.first >= 0 &&  now_position.second >= 0) {
                now_position = std::make_pair(now_position.second * -1, now_position.first);
                continue;
            }
